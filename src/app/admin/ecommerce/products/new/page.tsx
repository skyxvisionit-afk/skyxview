...
import { Plus, ArrowLeft, Package, DollarSign, Tag, Image as ImageIcon, CheckCircle } from 'lucide-react'
...
export default async function AdminNewProductPage() {
    ...
    async function addProduct(formData: FormData) {
        ...
        const { error } = await sp.from('ecommerce_products').insert({
            title,
            description,
            image_url,
        ...
        <div className="space-y-6 animate-fade-in-up pb-10 max-w-3xl mx-auto">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-400">Create a new reseller product for the network.</p>
                </div>
            </div>
            ...
            <div className="glass-card p-6 md:p-8">
                <form action={addProduct} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="number" name="stock" required min="0" defaultValue="100"
                            className="input-field w-full"
                            placeholder="e.g. 100" />
                    </div>
